...
把你在网易云音乐里长期留下的歌单和听歌痕迹，整理成一份适合交给 AI 阅读的数据。

它会采集你确认的主歌单、最近一周听歌排行和所有时间听歌排行，并把这些信息整理成本地文件。你可以把生成的数据交给自己信任的 AI，让它从长期偏好、近期状态、审美意象和细小异常里，慢慢靠近一个更具体的你。

这个项目只做采集和整理，不在采集过程中替你下结论。最终要不要分析、交给谁分析、分享哪些文件，都由你决定。
